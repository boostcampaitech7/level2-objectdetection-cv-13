...
from visualization import visualize_confusion_matrix, visualize_predictions_vs_groundtruth, calculate_class_confusion, visualize_feature_maps, visualize_precision_recall_curve
...
def main():
    ...
    def validate_and_visualize (runner, outputs):
        visualize_confusion_matrix(runner, outputs)
        visualize_predictions_vs_groundtruth(runner, outputs)
        visualize_feature_maps(runner, outputs)
        visualize_precision_recall_curve(runner, outputs)

    runner.train(validate=validate_and_visualize)
